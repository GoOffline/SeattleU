...
valid_df1_balance <- ROSE(TARGET ~ NAME_CONTRACT_TYPE + FLAG_OWN_CAR + FLAG_OWN_REALTY + CNT_CHILDREN + PERCENT_OF_INCOME + NAME_EDUCATION_TYPE + NAME_FAMILY_STATUS + NAME_HOUSING_TYPE + DAYS_EMPLOYED + OCCUPATION_TYPE , data = valid_df1, seed = 666)$data
...
confusionMatrix(class_tr1df1_predict, as.factor(train_df1_balance$TARGET))

# Then we use the model to predict the outcome for validation set. This will tell us how good (or lousy) our predictions are.
class_tr1df1_valid_predict <- predict(class_tr1df1, valid_df1_balance, type = "class")
t(t(head(class_tr1df1_valid_predict,10)))
confusionMatrix(class_tr1df1_valid_predict, as.factor(valid_df1_balance$TARGET))

# Compute the probabilities.
class_tr1df1_valid_predict_prob <- predict(class_tr1df1, valid_df1_balance, type = "prob")
...
#Deal with Unbalanced Data ......................................................................................................................................................................................................................................................
train_df2_balance <- ROSE(TARGET ~ CODE_GENDER + AMT_ANNUITY + NAME_INCOME_TYPE + DAYS_REGISTRATION,data = train_df2, seed = 1000)$data
Valid_df2_balance <- ROSE(TARGET ~ CODE_GENDER + AMT_ANNUITY + NAME_INCOME_TYPE + DAYS_REGISTRATION,data = valid_df2, seed = 1000)$data

#Build a Classification Tree (DF2) ..............................................................................................................................................................................................................................................
class_tr1df2 <- rpart(TARGET ~ CODE_GENDER + AMT_ANNUITY + NAME_INCOME_TYPE + DAYS_REGISTRATION, 
                      data = train_df2_balance,  method = "class", minbucket = 2, cp = 0.0006498616)
...
confusionMatrix(class_tr1df2_predict, as.factor(train_df2_balance$TARGET))

# Then we use the model to predict the outcome for validation set. This will tell us how good (or lousy) our predictions are.
class_tr1df2_valid_predict <- predict(class_tr1df2, Valid_df2_balance, type = "class")
t(t(head(class_tr1df2_valid_predict,10)))
confusionMatrix(class_tr1df2_valid_predict, as.factor(Valid_df2_balance$TARGET))

# Compute the probabilities.
class_tr1df2_valid_predict_prob <- predict(class_tr1df2, Valid_df2_balance, type = "prob")
...
#Deal with Unbalanced Data ......................................................................................................................................................................................................................................................
train_df3_balance <- ROSE(TARGET ~  CODE_GENDER + PERCENT_OF_INCOME + NAME_FAMILY_STATUS , data = train_df3, seed = 1000)$data
valid_df3_balance <- ROSE(TARGET ~  CODE_GENDER + PERCENT_OF_INCOME + NAME_FAMILY_STATUS , data = valid_df3, seed = 1000)$data

#Build a Classification Tree (DF3) ..............................................................................................................................................................................................................................................
class_tr1df3 <- rpart(TARGET ~ CODE_GENDER + PERCENT_OF_INCOME + NAME_FAMILY_STATUS,
                      data = train_df3_balance, method = "class", minbucket = 2, cp = .005315342)
...
confusionMatrix(class_tr1df3_predict, as.factor(train_df3_balance$TARGET))

# Then we use the model to predict the outcome for validation set. This will tell us how good (or lousy) our predictions are.
class_tr1df3_valid_predict <- predict(class_tr1df3, valid_df3_balance, type = "class")
t(t(head(class_tr1df3_valid_predict,10)))
confusionMatrix(class_tr1df3_valid_predict, as.factor(valid_df3_balance$TARGET))

# Compute the probabilities.
class_tr1df3_valid_predict_prob <- predict(class_tr1df3, valid_df3_balance, type = "prob")
...
str(valid_df4)
#Deal with Unbalanced Data ......................................................................................................................................................................................................................................................
train_df4_balance <- ROSE(TARGET ~ CODE_GENDER + AMT_INCOME_TOTAL + NAME_HOUSING_TYPE  + CNT_FAM_MEMBERS , data = train_df4, seed = 1000)$data
Valid_df4_balance <- ROSE(TARGET ~ CODE_GENDER + AMT_INCOME_TOTAL + NAME_HOUSING_TYPE  + CNT_FAM_MEMBERS , data = valid_df4, seed = 1000)$data
#Build a Classification Tree (DF4) ..............................................................................................................................................................................................................................................
class_tr1df4 <- rpart(TARGET ~ CODE_GENDER + AMT_INCOME_TOTAL + NAME_HOUSING_TYPE  + CNT_FAM_MEMBERS,
                      data = train_df4_balance,method = "class", minbucket = 2, cp = 0.0008496639)
...
confusionMatrix(class_tr1df4_predict, as.factor(train_df4_balance$TARGET))

# Then we use the model to predict the outcome for validation set. This will tell us how good (or lousy) our predictions are.
class_tr1df4_valid_predict <- predict(class_tr1df4, Valid_df4_balance, type = "class")
t(t(head(class_tr1df4_valid_predict,10)))
confusionMatrix(class_tr1df4_valid_predict, as.factor(Valid_df4_balance$TARGET))

# Compute the probabilities.
class_tr1df4_valid_predict_prob <- predict(class_tr1df4, Valid_df4_balance, type = "prob")
...
str(valid_df5)
#Deal with Unbalanced Data ......................................................................................................................................................................................................................................................
train_df5_balance <- ROSE(TARGET ~ CODE_GENDER + AMT_INCOME_TOTAL + FLAG_OWN_REALTY , data = train_df5, seed = 1000)$data
valid_df5_balance <- ROSE(TARGET ~ CODE_GENDER + AMT_INCOME_TOTAL + FLAG_OWN_REALTY , data = valid_df5, seed = 1000)$data

#Build a Classification Tree (DF5) ..............................................................................................................................................................................................................................................
class_tr1df5 <- rpart(TARGET ~ CODE_GENDER + AMT_INCOME_TOTAL + FLAG_OWN_REALTY,
                      data = train_df5_balance, method = "class", minbucket = 2, cp =0.0005891104)
...
confusionMatrix(class_tr1df5_predict, as.factor(train_df5_balance$TARGET))

# Then we use the model to predict the outcome for validation set. This will tell us how good (or lousy) our predictions are.
class_tr1df5_valid_predict <- predict(class_tr1df5, valid_df5_balance, type = "class")
t(t(head(class_tr1df5_valid_predict,10)))
confusionMatrix(class_tr1df5_valid_predict, as.factor(valid_df5_balance$TARGET))

# Compute the probabilities.
class_tr1df5_valid_predict_prob <- predict(class_tr1df5, valid_df5_balance, type = "prob")
